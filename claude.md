...
Courses: YTT-M1 (groups: All,G6,G7,G8), YTT-M2 (groups: All,G4), YTT-M3 (groups: All,G1,G2), I Ching (groups: All), AL (groups: All,G4), TTY-M3 (groups: All,G1 — English-language track "Tibetan Tantric Yoga module 3", separate from YTT-M3)
